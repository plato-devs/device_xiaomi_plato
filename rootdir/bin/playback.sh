...
function disable_receiver
{
    ...
    tinymix 'RCV AMP Enable Switch' 0
    tinymix 'RCV Spksw Gpio Switch' 0
...
function enable_speaker
{
    ...
    tinymix 'RCV AMP Enable Switch' 1
    tinymix 'SPK PCM Source' 'ASP'
    tinymix 'SPK AMP PCM Gain' 14
...
function disable_speaker
{
    ...
    tinymix 'SPK PCM Source' 'None'
    tinymix 'SPK AMP PCM Gain' 17
    tinymix 'SPK AMP Enable Switch' 0
}
